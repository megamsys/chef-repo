...
default[:rails][:app][:name] = "nilavu" # must be one word
...
default[:rails][:deploy][:repository] = "https://github.com/thomasalrin/nilavu.git" #nil
...
default[:rails][:database][:username] = "megam" #node[:rails][:app][:name]
default[:rails][:database][:password] = "team4megam" #node[:rails][:database][:password]  || ::SecureRandom.base64(12)
